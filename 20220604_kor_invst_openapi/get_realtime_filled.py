...
def subscribe(ws: websocket.WebSocketApp):
    ...
    hts_id, _, _ = common.get_account_infos('config_real.ini')
...
if __name__ == '__main__':
    ...
    websocket = websocket.WebSocketApp(common.BASE_REAL_WS_URL, on_open=on_open, on_message=on_message, on_error=on_error, on_close=on_close)
